...
boolean welcometodashboard = WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Popsoftware/Page_Welcome to HPL Site  HPL Site/strong_HPL Site'), 
    20, FailureHandling.CONTINUE_ON_FAILURE)

if (welcometodashboard == true) {
    System.out.println('Test Case Passed')
} else if (welcometodashboard == false) {
